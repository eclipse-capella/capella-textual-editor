...
public class TextualScenarioAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TextualScenarioSwitch<Adapter> modelSwitch =
    new TextualScenarioSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseLostFoundMessage(LostFoundMessage object)
      {
        return createLostFoundMessageAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.polarsys.capella.scenario.editor.dsl.textualScenario.LostFoundMessage <em>Lost Found Message</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLostFoundMessageAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.polarsys.capella.scenario.editor.dsl.textualScenario.LostMessage <em>Lost Message</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.polarsys.capella.scenario.editor.dsl.textualScenario.FoundMessage <em>Found Message</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
