...
public class TextualScenarioSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == TextualScenarioPackage.eINSTANCE)
			...
			case TextualScenarioPackage.REFERENCE:
				...
				return; 
			case TextualScenarioPackage.RETURN_MESSAGE:
	...
	protected void sequence_ReturnMessage(ISerializationContext context, ReturnMessage semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__TARGET) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__TARGET));
			if (transientValues.isValueTransient(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__SOURCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__SOURCE));
			if (transientValues.isValueTransient(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TextualScenarioPackage.Literals.RETURN_MESSAGE__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
