 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.scenario.editor.dsl.textualScenario.impl.SequenceMessageTypeImpl#getReturn <em>Return</em>}</li>
...
public class SequenceMessageTypeImpl extends MessageImpl implements SequenceMessageType
{
  ...
  public NotificationChain basicSetReturn(ReturnMessage newReturn, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TextualScenarioPackage.SEQUENCE_MESSAGE_TYPE__RETURN, oldReturn, newReturn);
  ...
  public void setReturn(ReturnMessage newReturn)
  {
    if (newReturn != return_)
    {
      ...
      if (return_ != null)
        msgs = ((InternalEObject)return_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TextualScenarioPackage.SEQUENCE_MESSAGE_TYPE__RETURN, null, msgs);
      if (newReturn != null)
        msgs = ((InternalEObject)newReturn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TextualScenarioPackage.SEQUENCE_MESSAGE_TYPE__RETURN, null, msgs);
      msgs = basicSetReturn(newReturn, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextualScenarioPackage.SEQUENCE_MESSAGE_TYPE__RETURN, newReturn, newReturn));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TextualScenarioPackage.SEQUENCE_MESSAGE_TYPE__RETURN:
