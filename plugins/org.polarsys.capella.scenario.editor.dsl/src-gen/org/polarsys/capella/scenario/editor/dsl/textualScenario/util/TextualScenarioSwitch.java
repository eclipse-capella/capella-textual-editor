...
public class TextualScenarioSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TextualScenarioPackage.LOST_FOUND_MESSAGE:
      {
        LostFoundMessage lostFoundMessage = (LostFoundMessage)theEObject;
        T result = caseLostFoundMessage(lostFoundMessage);
        if (result == null) result = caseMessage(lostFoundMessage);
        if (result == null) result = caseElement(lostFoundMessage);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case TextualScenarioPackage.FOUND_MESSAGE:
      {
        ...
        if (result == null) result = caseLostFoundMessage(foundMessage);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Lost Found Message</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Lost Found Message</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLostFoundMessage(LostFoundMessage object)
  {
    return null;
  }
