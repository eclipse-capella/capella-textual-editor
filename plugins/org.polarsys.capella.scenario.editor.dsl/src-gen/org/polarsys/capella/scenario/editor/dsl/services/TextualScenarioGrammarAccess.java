...
public class TextualScenarioGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ReturnMessageElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.polarsys.capella.scenario.editor.dsl.TextualScenario.ReturnMessage");
		private final Group cGroup = (Group)rule.eContents().get(1);
